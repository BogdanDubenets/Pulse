...
async def main():
    ...
    await bot.set_my_description(
        "Pulse 💓 — твій інтелектуальний фільтр у світі новин.\n\n"
        "Я перетворюю хаос із сотень Telegram-каналів на лаконічні AI-дайджести. Більше жодного скролінгу та дублікатів — лише те, що дійсно має значення для тебе.\n\n"
        "✨ Економ до 2 годин щодня.\n"
        "🚀 Читай найважливіше в один клік у Mini App."
    )
    await bot.set_my_short_description(
        "Pulse 💓 — AI-дайджест твоїх новин. Твій час — твій успіх. Читай головне!"
    )
